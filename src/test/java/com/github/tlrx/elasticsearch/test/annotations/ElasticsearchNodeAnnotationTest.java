...
public class ElasticsearchNodeAnnotationTest {
    ...
    private static final String NODE_LOCAL = "node.attr.local";
    ...
    @ElasticsearchNode(configFile = "com/github/tlrx/elasticsearch/test/annotations/elasticsearch-node4.yml")
    Node node4;
    ...
    public void testElasticsearchNodes() {
        ...
        assertEquals("zone1", node0.settings().get("node.attr.zone"));
        ...
        assertEquals("zone1", node4.settings().get("node.attr.zone"));
